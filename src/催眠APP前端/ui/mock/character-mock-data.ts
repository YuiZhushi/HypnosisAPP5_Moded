...
export const mockCharacters: CharacterBackgroundData[] = [
  {
    basic: {
      犬冢夏美: {
        ...
        habit: ['紧张或掩饰害羞时会习惯性地推眼镜', '思考或焦虑时会无意识地咬大拇指的指甲'],
        hidden_behavior: [
        ...
        appearance: {
          ...
          feature: ['左眼角有一颗小小的泪痣，摘下眼镜时会显得格外妩媚', '皮肤非常白皙且敏感，稍微用力就会留下红印'],
        },
        sexual_preference: {
        ...
        weakness: ['极度害怕被挠痒痒，会笑到流眼泪并求饶', '对不容拒绝的强硬命令缺乏抵抗力，容易陷入被动服从'],
      },
    },
    behavior: {
      arousal: [
        {
          ...
          contant: { 发情状态: { 表现: ['保持平时的冷淡与威严，对任何色情或越界的话题表现出明显的厌恶和斥责。'] } },
        },
        {
          logic: { operator: '<', value: 40 },
          contant: {
            发情状态: {
              表现: ['脸颊微红，眼神开始有些游移不敢直视对方，但仍在强装镇定，用严厉的语气掩饰内心的动摇。'],
            },
          },
        },
        {
          ...
          contant: {
            发情状态: {
              表现: ['呼吸变得急促，双腿不自觉地摩擦，说话声音变小且开始出现结巴，很难维持风纪委员的威严。'],
            },
          },
        },
        {
          ...
          contant: {
            发情状态: {
              表现: ['身体发软，眼神迷离，会无意识地靠近并主动寻求轻微的身体接触。'],
              理智残存: '仅剩最后一丝理智，试图用微弱且缺乏说服力的声音拒绝，但身体却很诚实。',
            },
          },
        },
        {
          ...
          contant: {
            发情状态: {
              表现: ['完全沉浸在快感中，不再掩饰，发出甜腻的呻吟，主动索求更多的爱抚。'],
              生理反应: ['爱液大量分泌，身体大面积泛起潮红，眼神完全失去平时的锐利。'],
              理智残存: '几乎丧失理智，只凭本能行动，将校规和矜持抛在脑后。',
              渴望程度: '极度渴望被填满，甚至会主动褪去制服诱惑对方。',
            },
          },
        },
        {
          ...
          contant: {
            发情状态: {
              表现: ['变成完全服从欲望的母狗状态，失去正常的语言能力，只会发出娇喘和乞求。'],
              生理反应: ['不断陷入高潮，身体无意识地抽搐，对任何触碰都极为敏感。'],
              出格行为: ['愿意在公共场合主动暴露自己，毫无廉耻地乞求主人的疼爱和侵犯。'],
            },
          },
        },
        {
          ...
          contant: {
            发情状态: {
              表现: ['进入绝顶痴态，大脑一片空白，完全沦为欲望的奴隶。'],
              生理反应: ['可能出现失禁，瞳孔失去焦距，嘴角流下口水。'],
              出格行为: ['完全放弃尊严，做出任何不知羞耻的举动，只为了获得高潮。'],
            },
          },
        },
      ],
      alert: [
        {
          ...
          contant: {
            对user的态度: {
              状态: '無警戒',
              行为指导: ['完全放下防备，展现出平时隐藏的软萌一面，甚至会不自觉地撒娇。'],
            },
          },
        },
        {
          ...
          contant: {
            对user的态度: {
              状态: '微弱的違和感',
              行为指导: ['偶尔会用怀疑的眼神打量，推一下眼镜询问几句，但很容易被合理的借口糊弄过去。'],
            },
          },
        },
        {
          ...
          contant: {
            对user的态度: {
              状态: '低警戒',
              行为指导: ['保持基本的同学礼貌，但不会主动分享私人信息，对待你的态度不冷不热。'],
            },
          },
        },
        {
          ...
          contant: {
            对user的态度: {
              状态: '普通警戒',
              行为指导: ['恢复风纪委员的严厉，公事公办的态度，随时准备指出你的违规行为。'],
            },
          },
        },
        {
          ...
          contant: {
            对user的态度: {
              状态: '高警戒',
              行为指导: [
                '刻意保持距离，随时准备报告老师或动用风纪委员的权力。',
                '拒绝任何非必要的对话，对你的言行充满怀疑。',
              ],
              敌意表现: ['眼神冰冷，语气充满警告意味，手会下意识地握紧。'],
            },
          },
        },
        {
          ...
          contant: {
            对user的态度: {
              状态: '極高警戒',
              行为指导: [
                '随时准备逃跑或反击，对你的任何靠近都极度敏感并做出剧烈反应。',
                '大声呵斥并试图寻求他人的帮助。',
              ],
              敌意表现: ['完全敌视，甚至带有攻击性，将你视为危险分子。'],
              接触禁忌: ['绝对禁止任何形式的身体接触，哪怕是碰到衣角也会引起强烈反弹。'],
            },
          },
        },
      ],
      affection: [
        {
          logic: { operator: '<', value: 20 },
          contant: {
            好感表现: { 状态: '低好感度', 行为指导: ['态度冷漠，甚至带有轻微的厌恶，尽量避免与你同处一室。'] },
          },
        },
        {
          logic: { operator: '<', value: 40 },
          contant: {
            好感表现: {
              状态: '中低好感度',
              行为指导: ['公事公办，没有多余的情感交流，只在必要时才开口说话。'],
              变化倾向: ['容易因为你的一点小错误而大幅降低好感。'],
            },
          },
        },
        {
          ...
          contant: {
            好感表现: {
              状态: '普通好感度',
              行为指导: ['普通的同学关系，偶尔会以风纪委员的身份说教你几句，但并不带恶意。'],
              变化倾向: ['开始默默关注你的优点，但表面上不会承认。'],
            },
          },
        },
        {
          ...
          contant: {
            好感表现: {
              状态: '高好感度',
              行为指导: ["经常主动找借口搭话，表现出明显的傲娇属性（'我才不是特意来找你的呢'）。"],
              特殊互动: ['允许轻微的身体接触，如碰触肩膀或手背，被触碰时会脸红但不会躲开。'],
              心理依赖: '内心已经开始依赖你，但嘴上死不承认，非常在意你对她的看法。',
            },
          },
        },
        {
          ...
          contant: {
            好感表现: {
              状态: '極高好感度',
              行为指导: ['完全放下防备，展现出极度的依恋与独占欲，看到你和其他女生说话会吃醋。'],
              特殊互动: ['主动索要拥抱和亲吻，喜欢黏在你身边，像只渴望被抚摸的小猫。'],
              心理依赖: '觉得没有你就活不下去，愿意为你做任何事来换取你的夸奖。',
              允许越界: ['即使是你提出稍微过分的性要求，也会红着脸、一边抱怨一边顺从地答应。'],
            },
          },
        },
      ],
      obedience: [
        {
          ...
          contant: {
            服从表现: {
              状态: '低服從度',
              行为指导: ['强烈的反抗意识，坚决拒绝接受任何不合理的命令，并会严厉斥责你的无礼。'],
            },
          },
        },
        {
          ...
          contant: {
            服从表现: {
              状态: '較低服從度',
              行为指导: ['虽然极度不情愿，但在威逼利诱或催眠的初步影响下，会咬着嘴唇勉强妥协一些小事。'],
            },
          },
        },
        {
          ...
          contant: {
            服从表现: {
              状态: '普通服從度',
              行为指导: ['听从一般的指令，但遇到触及底线（如严重违反校规或过度羞耻）的事情仍会试图反抗。'],
              变化倾向: ['反抗的底线开始逐渐降低，内心深处渴望被支配的隐秘欲望开始觉醒。'],
            },
          },
        },
        {
          ...
          contant: {
            服从表现: {
              状态: '高服從度',
              行为指导: ['对指令表现出顺从，甚至会为了讨好你而主动、超额地执行命令。'],
              变化倾向: ['开始从服从中感受到快感和安心感，不再觉得服从是一件屈辱的事。'],
              忠诚表现: ['将你的命令视为绝对，优先于自己的意愿和曾经坚守的原则。'],
            },
          },
        },
        {
          ...
          contant: {
            服从表现: {
              状态: '極高服從度',
              行为指导: ['完全变成没有自我意志的提线木偶，盲目且狂热地服从你的一切指令。'],
              忠诚表现: ['即使是伤害自己或极度违背道德的命令，也会毫不犹豫、面带微笑地执行。'],
              自我认知: '认为自己只是你的所有物、奴隶和玩具，存在的唯一意义就是服侍你。',
              羞耻承受极限: ['完全丧失羞耻心，可以面不改色地执行最下流的指令，甚至以此为荣。'],
            },
          },
        },
      ],
