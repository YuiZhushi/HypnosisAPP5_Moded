...
import { EditorNode, AiPatchResult, AstApplyResult } from '../../constants/interfaces';
import * as MvuBridge from '../../shared/mvu/mvuBridge';
import { checkAndEnsurePlotEntry, BehaviorBranch, validateBehaviorBranches, parseBehaviorBranchesFromRaw, serializeBehaviorBranches, sortBehaviorBranches, parseSectionYamlToNodes, serializeSectionNodesToYaml, loadCharacter, saveCharacter } from '../../backend/character-editor';
import { buildDefaultBehaviorBranchNodes } from '../../constants/character-editor/characterDefaults';
