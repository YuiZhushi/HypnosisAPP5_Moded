/**
 * 設定提示詞預設配置（Phase D-2 從 dataService.ts 搬遷）
 *
 * 搬遷說明：此大型常數原位於 dataService.ts L131-190，
 * 已於 2026-04-16 手動搬遷至此，保持原文內容不變。
 */

// 型別定義需要從 dataService.ts 重新匯出，避免循環依賴
