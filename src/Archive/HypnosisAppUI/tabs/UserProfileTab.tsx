...
export const UserProfileTab: React.FC = () => {
  const { userData, calculateExchangeResult, canExchange, performExchange, canUpgradeVip, upgradeVip } =
    useUserProfileLogic();
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <section className="bg-black/40 backdrop-blur-sm rounded-xl p-3 border border-white/10 flex flex-col justify-between">
            <div>
              ...
              <div className="text-lg font-mono font-bold text-white mb-2">¥ {userData.money.toLocaleString()}</div>
            </div>
            <button
          ...
          <section className="bg-black/40 backdrop-blur-sm rounded-xl p-3 border border-white/10 flex flex-col justify-between">
            <div>
              ...
              <div className="text-lg font-mono font-bold text-white mb-2">{userData.mcPoints.toLocaleString()} PT</div>
            </div>
            <button
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <span className="absolute right-3 text-gray-500 text-sm font-bold">{config.inputUnit}</span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center bg-white/5 p-3 rounded-lg border border-white/10">
                ...
                <span
                  className={`text-lg font-bold ${
                    config.type === 'RESTORE_ENERGY'
                      ? 'text-red-400'
                      : config.type === 'UPGRADE_MAX_ENERGY'
                        ? 'text-blue-400'
                        : config.type === 'PT_TO_MONEY'
                          ? 'text-green-400'
                          : 'text-blue-400'
                  }`}
                >
                  {config.costUnit === '¥'
                    ...
                    : `${calculatedResult.toLocaleString()} PT`}
                </span>
              </div>
            </div>
