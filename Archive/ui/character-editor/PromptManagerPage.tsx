...
import { getEditorModules, saveEditorModules, getDefaultEditorModules, buildEditorPipelineParams } from '../../backend/character-editor';
...
export const PromptManagerPage: React.FC<PromptManagerPageProps> = ({
  ...
  const handleResetModule = useCallback((moduleId: string) => {
    const defaults = getDefaultEditorModules();
